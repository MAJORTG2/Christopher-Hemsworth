...
def start(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text('Hello! I am a clone of the original bot.')

def help(update: Update, context: CallbackContext) -> None:
    """Handler function for the /help command"""
    update.message.reply_text('I am a clone of the original bot. I do not have any additional features.')

def clone_bot(update: Update, context: CallbackContext) -> None:
    """Handler function for the /clonebot command"""
    original_bot = Bot(ORIGINAL_BOT_TOKEN)
    original_bot_info = original_bot.get_me()

    new_bot = context.bot
    new_bot.username = original_bot_info.username
    new_bot.set_my_commands([InlineKeyboardButton(command, callback_data=command) for command in COMMANDS])
    new_bot_info = new_bot.get_me()

    update.message.reply_text(f'The new bot {new_bot_info.username} has been created and its features have been cloned from the original bot {original_bot_info.username}.')
